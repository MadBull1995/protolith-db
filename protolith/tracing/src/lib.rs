...
const ENV_LOG_LEVEL: &str = "PROTOLITH_LOG";
const ENV_LOG_FORMAT: &str = "PROTOLITH_LOG_FORMAT";
const ENV_ACCESS_LOG: &str = "PROTOLITH_ACCESS_LOG";

const DEFAULT_LOG_LEVEL: &str = "info,protolith_app::layer=trace";
